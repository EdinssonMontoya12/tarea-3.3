package com.edinsson.tarea_semana_3.view;
...
import com.edinsson.tarea_semana_3.R;
import com.edinsson.tarea_semana_3.adapter.PictureFiveFavoriteRecyclerViewAdapter;
import com.edinsson.tarea_semana_3.adapter.PictureMainRecyclerViewAdapter;
import com.edinsson.tarea_semana_3.modelo.CardViewMain;

public class fiveFavorites extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_five_favorites);
        showToolBar("", true);

        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recyclerview_five_favorite);
        ...
        PictureFiveFavoriteRecyclerViewAdapter pictureFiveFavoriteRecyclerViewAdapter = new PictureFiveFavoriteRecyclerViewAdapter(buidPicture(), R.layout.card_pet_main);
        recyclerView.setAdapter(pictureFiveFavoriteRecyclerViewAdapter);
    }
    ...
    public CardViewMain[] buidPicture() {
        CardViewMain[] pictures = new CardViewMain[5];
        pictures[0] = (new CardViewMain("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/22c25b0c-a2e2-4140-a38b-010b64" +
        ...
        pictures[1] = (new CardViewMain("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/2e2ca105-22d3-44e7-ad36-b1ef4ac17cf7" +
        ...
        pictures[2] = (new CardViewMain("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/839ad802-cfe4-4f36-9be7-6a6d5d6c7302" +
        ...
        pictures[3] = (new CardViewMain("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/93aac52b-ed16-4e2d-b102-d27b478ea440" +
        ...
        pictures[4] = (new CardViewMain("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/538984eb-ab47-4c13-bfa8-b4f1aea20e2d/" +
